...
[![English](https://img.shields.io/badge/lang-English-4a5568)](README.en.md) ![简体中文](https://img.shields.io/badge/lang-简体中文-e8b45c)

一条给 2:1 等距游戏用的预渲染管线，以及用它做出来的一个农场场景。

<sub>An offline pre-rendering pipeline for 2:1 isometric games, and a farming scene built with it.</sub>
